...
![Интерфейс приложения](./docs/screenshots/001.jpg)

CSV файл успешно загружен
![Интерфейс приложения](./docs/screenshots/002.jpg)

Анализ CSV файла завершен
![Интерфейс приложения](./docs/screenshots/003.jpg)

Фильтрация пациентов с низким риском 
![Интерфейс приложения](./docs/screenshots/004.jpg)

Просмотр результатов теста пациента #9471 (**низкий** риск сердечного приступа)
![Интерфейс приложения](./docs/screenshots/005.jpg)

Просмотр результатов теста пациента #7746 (**высокий** риск сердечного приступа)
![Интерфейс приложения](./docs/screenshots/006.jpg)

Фильтрация пациентов содержащих в ID последовательность 464
![Интерфейс приложения](./docs/screenshots/008.jpg)

Отчёт пациента #7746 успешно скачан
![Интерфейс приложения](./docs/screenshots/007.jpg)

Просмотр файла **cardiorisk_report_patient_7746_2026-01-18.txt**
<img src="./docs/screenshots/009.jpg" width="540" />
